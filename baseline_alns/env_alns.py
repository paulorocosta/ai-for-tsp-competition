...
class alnsState:
    ...
    def evaluate_individual_solution(self, instance_name, solution, n_nodes, seed):
    ...
    def objective(self):
        ...
        score = self.evaluate_individual_solution(self.instance_name, evaluation_tour, len(self.x), self.seed)
        return score
